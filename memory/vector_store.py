...
class AzureAISearchVectorStore:
    ...
    def __init__(
        ...
        self.index_name = index_name or os.getenv("AZURE_SEARCH_INDEX_NAME", "research-papers")
    ...
    def add_documents(
        ...
        print(f"Uploaded {len(docs_to_upload)} documents. Succeeded: {len([r for r in result if r.succeeded])}")
